...
class ValidateRequestPluginTest extends TestCase {
	...
	public function setUp() {
		...
		$this->plugin = new ValidateRequestPlugin();
	}
	 ...
	 */
	public function testNewChunkingInOldEndpoint1() {
		$headers['OC-Chunk-Offset'] = 0;
		$GLOBALS["service"] = 'webdav';
	...
	/**
	 * @expectedException \Sabre\DAV\Exception\ServiceUnavailable
	 * @expectedExceptionMessage Specified HTTP_OC_CHUNKED/OC-Chunked header is allowed only in webdav endpoint
	 */
